 ...
 * SPDX-License-Identifier: AGPL-3.0-or-later
 */
$(document).ready(function(){$("#q").length&&($("#categories label").click(function(e){return $('#categories input[type="checkbox"]').each(function(e,t){$(t).prop("checked",!1)}),$(document.getElementById($(this).attr("for"))).prop("checked",!0),$("#q").val()&&("GET"==getHttpRequest()&&$("#search_form").attr("action",$("#search_form").serialize()),$("#search_form").submit()),!1}),$("#time-range").change(function(e){$("#q").val()&&("GET"==getHttpRequest()&&$("#search_form").attr("action",$("#search_form").serialize()),$("#search_form").submit())}),$("#language").change(function(e){$("#q").val()&&("GET"==getHttpRequest()&&$("#search_form").attr("action",$("#search_form").serialize()),$("#search_form").submit())}))});function getHttpRequest(){return httpRequest="POST",(urlParams=new URLSearchParams(window.location.search)).has("method")&&(httpRequest=urlParams.get("method")),httpRequest}
